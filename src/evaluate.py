...
def total_metric(input_path, output_path, thr):
    ...
    print(metrics.precision_score(labels, pred_labels))
    print(metrics.recall_score(labels, pred_labels))
...
# metric("./model/APLSTM/output_test", 0.15)
# metric("./model/APLSTM/output_test", 0.16)
# metric("./model/APLSTM/output_test", 0.17)
# metric("./model/APLSTM/output_test", 0.18)
# metric("./model/APLSTM/output_test", 0.19)
...
# metric("./model/FastText/output_test", 0.32)
# metric("./model/FastText/output_test", 0.33)
# metric("./model/FastText/output_test", 0.34)
...
# metric("./model/TextCNN/output_test", 0.33)
# metric("./model/TextCNN/output_test", 0.34)
# metric("./model/TextCNN/output_test", 0.35)
# metric("./model/TextCNN/output_test", 0.42)
...
# metric("./model/SCWLSTM/output_test", 0.94)
# metric("./model/SCWLSTM/output_test", 0.93)
# metric("./model/SCWLSTM/output_test", 0.92)
# metric("./model/SCWLSTM/output_test", 0.91)
# metric("./model/SCWLSTM/output_test", 0.9)
...
# metric("output_test", 0.05)
# metric("output_test", 0.1)
# metric("output_test", 0.2)
# metric("output_test", 0.3)
# metric("output_test", 0.4)
# metric("output_test", 0.5)
# metric("output_test", 0.6)
# metric("output_test", 0.7)
# metric("output_test", 0.8)
# metric("output_test", 0.9)
# metric("output_test", 0.9)
metric("output_test", 0.91)
metric("output_test", 0.92)
metric("output_test", 0.93)
metric("output_test", 0.94)
metric("output_test", 0.95)
metric("output_test", 0.99)
