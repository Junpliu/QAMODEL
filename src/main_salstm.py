...
# save model path
flags.DEFINE_string("model_dir", "/ceph/qbkg/aitingliu/qq/src/model/20190809/SALSTM3/", "model path")
flags.DEFINE_string("log_dir", "/ceph/qbkg/aitingliu/qq/src/logdir/20190809/SALSTM3/", "logdir path")
flags.DEFINE_string("export_path", "/ceph/qbkg/aitingliu/qq/src/model/20190809/SALSTM3/tfmodel/", "tf.serving model path")
...
flags.DEFINE_integer("d_a_size", 100, "d_a_size of self-attention.")
flags.DEFINE_integer("r_size", 30, "r_size of self-attention")
