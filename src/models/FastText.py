...
class FastText(object):
    ...
    def build_graph(self):
        with tf.variable_scope("net"):
            ...
            word_rep1 = self.compute_mean_vector(word_embed1, self.max_word_len1)
            word_rep2 = self.compute_mean_vector(word_embed2, self.max_word_len2)
            char_rep1 = self.compute_mean_vector(char_embed1, self.max_char_len1)
            char_rep2 = self.compute_mean_vector(char_embed2, self.max_char_len2)
