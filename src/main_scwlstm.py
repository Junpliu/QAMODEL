...
# save model path
flags.DEFINE_string("model_dir", "model/qq_simscore/SCWLSTM", "model path")
...
flags.DEFINE_string("ckpt_name", "scwlstm.ckpt", "Checkpoint file name.")
...
flags.DEFINE_boolean("infer", True, "infer mode")
