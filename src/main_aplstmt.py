...
# save model path
flags.DEFINE_string("model_dir", "/ceph/qbkg/aitingliu/qq/src/model/20190809/APLSTMT3/", "model path")
flags.DEFINE_string("log_dir", "/ceph/qbkg/aitingliu/qq/src/logdir/20190809/APLSTMT3/", "logdir path")
