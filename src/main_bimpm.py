...
# save model path
flags.DEFINE_string("model_dir", "model/BiMPM", "model path")
flags.DEFINE_string("log_dir", "logdir/BiMPM", "model path")
...
flags.DEFINE_float("dropout_rate", 0.5, "Dropout rate (not keep_prob) default: 0.5)")
