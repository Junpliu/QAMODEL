...
# save model path
flags.DEFINE_string("model_dir", "model/qq_simscore/BiMPM", "model path")
...
flags.DEFINE_string("ckpt_name", "BiMPM.ckpt", "Checkpoint file name.")
...
flags.DEFINE_float("dropout_rate", 0.3, "Dropout rate (not keep_prob) default: 0.3)")
