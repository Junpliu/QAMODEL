...
| 模型     | 指标            | AUC    | ACC    | PRE    | REC    | F1     | 阈值 | 备注             |
| -------- | --------------- | ------ | ------ | ------ | ------ | ------ | ---- | ---------------- |
| FastText | QQ Pair级别指标 | 0.7240 | 0.7611 | 0.5982 | 0.6780 | 0.6356 | 0.33 | 最高F1，30 epoch |
| ARCII    | QQ Pair级别指标 | 0.7240 | 0.6925 | 0.4997 | 0.5033 | 0.5015 | 0.8  | 高阈值，30 epoch |
| ARCII    | QQ Pair级别指标 | 0.7240 | 0.7012 | 0.5150 | 0.4746 | 0.4940 | 0.9  | 高阈值，30 epoch |
