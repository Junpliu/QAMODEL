...
flags.DEFINE_string("log_dir", "/ceph/qbkg/aitingliu/qq/src/logdir/ARCIIT/", "logdir path")

# data file path
flags.DEFINE_string("train_file", "/ceph/qbkg/aitingliu/qq/data/20190726/triplet/train.txt", "Training data file.")
flags.DEFINE_string("dev_file", "/ceph/qbkg/aitingliu/qq/data/20190726/triplet/dev.txt", "Development data file.")
flags.DEFINE_string("test_file", "/ceph/qbkg/aitingliu/qq/data/20190726/triplet/test.txt", "Test data file.")
flags.DEFINE_string("infer_file", "/ceph/qbkg/aitingliu/qq/data/20190726/raw/test.txt", "Test data file.")
flags.DEFINE_string("word_vocab_file", "/ceph/qbkg/aitingliu/qq/data/20190726/triplet/word.txt", "Word vocabulary file.")
flags.DEFINE_string("char_vocab_file", "/ceph/qbkg/aitingliu/qq/data/20190726/triplet/char.txt", "Char vocabulary file.")
