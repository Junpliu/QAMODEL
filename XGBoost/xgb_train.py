...
parser.add_argument("--train_data_file", type=str, default='/ceph/qbkg2/aitingliu/qq/data/20190726/raw/train.txt')
parser.add_argument("--val_data_file", type=str, default='/ceph/qbkg2/aitingliu/qq/data/20190726/raw/dev.txt')
parser.add_argument("--test_data_file", type=str, default='/ceph/qbkg2/aitingliu/qq/data/20190726/raw/test.txt')
parser.add_argument("--x_train_file", type=str, default='/ceph/qbkg2/aitingliu/qq/XGBoost/data/with_scwlstm/x_train.csv')
parser.add_argument("--x_valid_file", type=str, default='/ceph/qbkg2/aitingliu/qq/XGBoost/data/with_scwlstm/x_valid.csv')
parser.add_argument("--x_test_file", type=str, default='/ceph/qbkg2/aitingliu/qq/XGBoost/data/with_scwlstm/x_test.csv')
parser.add_argument("--y_train_file", type=str, default='/ceph/qbkg2/aitingliu/qq/XGBoost/data/with_scwlstm/y_train.csv')
parser.add_argument("--y_valid_file", type=str, default='/ceph/qbkg2/aitingliu/qq/XGBoost/data/with_scwlstm/y_valid.csv')
parser.add_argument("--y_test_file", type=str, default='/ceph/qbkg2/aitingliu/qq/XGBoost/data/with_scwlstm/y_test.csv')
parser.add_argument("--dtrain_file", type=str, default='/ceph/qbkg2/aitingliu/qq/XGBoost/data/with_scwlstm/dtrain.buffer')
parser.add_argument("--dvalid_file", type=str, default='/ceph/qbkg2/aitingliu/qq/XGBoost/data/with_scwlstm/dvalid.buffer')
parser.add_argument("--dtest_file", type=str, default='/ceph/qbkg2/aitingliu/qq/XGBoost/data/with_scwlstm/dtest.buffer')
parser.add_argument("--pred_data_file", type=str, default='/ceph/qbkg2/aitingliu/qq/XGBoost/tmp/with_scwlstm/results_xgb.csv')
parser.add_argument("--word_counts_file", type=str, default='/ceph/qbkg2/aitingliu/qq/XGBoost/tmp/with_scwlstm/word_counts')
parser.add_argument("--feature_map_file", type=str, default='/ceph/qbkg2/aitingliu/qq/XGBoost/tmp/with_scwlstm/feature_map')
parser.add_argument("--train_scwlstm_pred_file", type=str, default="/ceph/qbkg2/aitingliu/qq/src/model/SCWLSTM/best_eval_loss/output_train")
parser.add_argument("--val_scwlstm_pred_file", type=str, default="/ceph/qbkg2/aitingliu/qq/src/model/SCWLSTM/best_eval_loss/output_dev")
