...
parser.add_argument("--first_predict", dest='first_predict', action='store_true')
parser.add_argument("--not_first_predict", dest='first_predict', action='store_false')
parser.add_argument("--test_data_file", type=str, default='/ceph/qbkg2/aitingliu/qq/data/20190726/raw/test.txt')
parser.add_argument("--x_test_file", type=str, default='/ceph/qbkg2/aitingliu/qq/XGBoost/data_with_scwlstm/x_test.csv')
parser.add_argument("--y_test_file", type=str, default='/ceph/qbkg2/aitingliu/qq/XGBoost/data_with_scwlstm/y_test.csv')
parser.add_argument("--dtest_file", type=str, default='/ceph/qbkg2/aitingliu/qq/XGBoost/data_with_scwlstm/dtest.buffer')
parser.add_argument("--pred_data_file", type=str, default='/ceph/qbkg2/aitingliu/qq/XGBoost/tmp_with_scwlstm/results_xgb.csv_tmp_')
parser.add_argument("--word_counts_file", type=str, default='/ceph/qbkg2/aitingliu/qq/XGBoost/tmp_with_scwlstm/word_counts')
...
parser.add_argument("--model_path", type=str, default="/ceph/qbkg2/aitingliu/qq/XGBoost/model_with_scwlstm/model")
