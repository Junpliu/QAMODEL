...
# save model path
flags.DEFINE_string("model_dir", "/ceph/qbkg/aitingliu/qq/src/model/20190809/APCNNT3/", "model path")
flags.DEFINE_string("log_dir", "/ceph/qbkg/aitingliu/qq/src/logdir/20190809/APCNNT3/", "logdir path")

# data file path
flags.DEFINE_string("train_file", "/ceph/qbkg/aitingliu/qq/data/20190809/triplet/train.txt", "Training data file.")
flags.DEFINE_string("dev_file", "/ceph/qbkg/aitingliu/qq/data/20190809/triplet/dev.txt", "Development data file.")
flags.DEFINE_string("test_file", "/ceph/qbkg/aitingliu/qq/data/20190809/triplet/test.txt", "Test data file.")
flags.DEFINE_string("infer_file", "/ceph/qbkg/aitingliu/qq/data/20190809/raw/test.txt", "Infer data file.")
flags.DEFINE_string("word_vocab_file", "/ceph/qbkg/aitingliu/qq/data/20190809/triplet/word.txt", "Word vocabulary file.")
flags.DEFINE_string("char_vocab_file", "/ceph/qbkg/aitingliu/qq/data/20190809/triplet/char.txt", "Char vocabulary file.")
...
flags.DEFINE_string("metrics", "eval_loss", "evaluations metrics (accuracy | f1)")
...
flags.DEFINE_integer("fc_size", 300, "Fully connected layer hidden size. (default: 1024)")
...
flags.DEFINE_float("margin", 1.0, "Max margin")
...
def main(unused):
    ...
    model_creator = APCNNT.APCNNT

    # train
    if FLAGS.train:
        logger.info("TRAIN")
        train_triplet.train(FLAGS, model_creator)

    # evaluate
    if FLAGS.test:
        logger.info("TEST")
        train_triplet.test(FLAGS, model_creator)
