...
# save model path
flags.DEFINE_string("model_dir", "/ceph/qbkg/aitingliu/qq/src/model/20190809/ARCIIT3/", "model path")
flags.DEFINE_string("log_dir", "/ceph/qbkg/aitingliu/qq/src/logdir/20190809/ARCIIT3/", "logdir path")
...
flags.DEFINE_integer("fc_size", 200, "Fully connected layer hidden size. (default: 1024)")
